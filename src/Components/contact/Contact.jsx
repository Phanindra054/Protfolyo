            ...
            <div className="contact_content">
                ...
                <div className="contact_info">
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">dommeti.phanindra2004@gmail.com</span>
                    ...
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">7981117541</span>
                    ...
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">Dommeti Phanindra</span>
            ...
            <div className="contact_content">
                ...
                <form ref={form} onSubmit={sendEmail} action="" className="contact_form">
                    ...
                    <div className="contact_form-div">
                        ...
                        <input type="email" name='name' className="contact_form-input" placeholder='Insert your email'/>
                    </div>
